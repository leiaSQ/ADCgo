...
// Host cost is n*ckptBasisChunkCols*8 bytes (production SIP, n≈518k: ~1.1 GB) instead of the whole
// n*dim basis.
...
//
// It is chunked because downloading the whole basis at once is what made the production SIP solve
