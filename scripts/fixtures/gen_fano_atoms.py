...
Run with the adcgo conda env:
    .../envs/adcgo/bin/python scripts/fixtures/gen_fano_atoms.py [--basis aug-cc-pVQZ] [atoms...]
"""
import os
import sys
...
sys.path.insert(0, os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "fcidump"))
...
OUT = os.environ.get("FANO_OUT", os.path.join(os.path.dirname(os.path.dirname(HERE)), "testdata", "fano"))
