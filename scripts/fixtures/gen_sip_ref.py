...
Writes testdata/h2o_sip.pyscf.json. Run in the `adcgo` conda env (pyscf 2.13):
    /home/leia/miniconda3/envs/adcgo/bin/python scripts/fixtures/gen_sip_ref.py
"""
import json
import os
...
# Must match scripts/fixtures/gen_fcidump.py exactly (same mol => same integrals as
