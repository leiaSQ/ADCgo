...
var helpTopics = []helpTopic{
	// ---------------------------------------------------------------- input
	{
		...
		body: []string{
			...
			"",
			"    python scripts/gen_fcidump.py                 # testdata/h2o.fcidump + h2o.mo.json",
	...
	},
	{
		...
		flags: []string{"fano", "fano-init", "fano-q", "fano-rule", "fano-qp", "fano-nth", "fano-qmin"},
		see:   []string{"fanotuning", "stieltjes", "order22"},
	},
	{
		key:     "fanotuning",
		...
		flags: []string{
			...
			"fano-emax", "fano-emax-rel", "fano-wmin", "fano-gmin", "fano-at",
		},
	...
	},
	{
		...
		body: []string{
			...
			"",
			"-satchunk and -sat-trace tune and instrument the matrix-free satellite apply. See scripts/HELIX.md for a complete SLURM job.",
			"",
